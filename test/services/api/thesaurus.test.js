...
test('getDomainTerms func: get terms of countries', () => {  
  return myAPI.getDomainTerms("regions").then(data=> {
    expect.soft(data).toEqual( 
      expect.arrayContaining([ 
        expect.objectContaining({
...
test('getDomainTerms func: get terms of countries', () => {  
  return myAPI.getDomainTerms("regions",{ relations:"domain" }).then(data=> {
    expect.soft(data).toEqual( 
      expect.arrayContaining([ 
        expect.objectContaining({
            "termId":           expect.any(Number),
