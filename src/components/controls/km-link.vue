<template>
    <!-- <a :href="to" :class="{'active' : route.path === to}" :target="target" v-bind="$attrs"> -->
    <a :href="to"  :target="target" v-bind="$attrs">
        <slot>
            ...
            <font-awesome-icon class="fa fa-address-book" aria-hidden="true"/>
            {{title}}
        </slot>
    </a> 
</template>
