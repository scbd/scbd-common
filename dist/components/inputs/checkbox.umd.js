(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('vue')) : typeof define === 'function' && define.amd ? define(['vue'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.ScbdCommonComponentsInputsCheckbox = factory(global.vue));
})(this, function (vue) {
  'use strict';
  ...
  var script = {
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        ...
        }, null, 10 /* CLASS, PROPS */, _hoisted_1), [[vue.vModelCheckbox, model.value]]), vue.createElementVNode("label", {
          for: _ctx.$attrs.id,
