import { openBlock, createElementBlock, createElementVNode, toDisplayString, renderSlot, computed, createBlock, unref, isRef, withCtx, withModifiers, createCommentVNode, useModel, createVNode, ref, useSlots, onMounted, onBeforeUnmount, Fragment, createTextVNode, inject, normalizeClass, mergeModels, withDirectives, vModelRadio } from 'vue';
...
const _hoisted_4$1 = { class: "card-header" };
  ...
  return (openBlock(), createElementBlock("div", _hoisted_1$6, [
    createElementVNode("div", _hoisted_2$3, [
      createElementVNode("div", _hoisted_3$2, [
        createElementVNode("div", _hoisted_4$1, toDisplayString(_ctx.$attrs["card-header"]), 1 /* TEXT */),
  ...
  return (openBlock(), createBlock(unref(VueMultiselect), {
    ...
    default: withCtx(() => [
      renderSlot(_ctx.$slots, "clear", {}, () => [
        createElementVNode("template", _hoisted_1$5, [
...
const _hoisted_1$4 = { class: "scbd-common km-government" };
...
return (_ctx, _cache) => {
  return (openBlock(), createElementBlock("div", _hoisted_1$4, [
    createVNode(script$5, {
      ...
      "track-by": "code",
      "value-key": "code",
      placeholder: _ctx.$attrs.placeholder || unref(t)('government'),
...
const _hoisted_1$1 = { class: "scbd-common km-language" };
...
const _hoisted_1 = /*#__PURE__*/createElementVNode("h3", null, "CBD selectors components", -1 /* HOISTED */);
    
var script = {
  __name: 'preview',
  setup(__props) {

    const selectedItems = ref({ "identifier": "ag" });

return (_ctx, _cache) => {
  return (openBlock(), createElementBlock("div", null, [
    _hoisted_1,
    createVNode(script$6, { "card-header": "Language selector" }, {
      left: withCtx(() => [
        createVNode(script$1, {
          modelValue: selectedItems.value,
          "onUpdate:modelValue": _cache[0] || (_cache[0] = $event => ((selectedItems).value = $event))
        }, null, 8 /* PROPS */, ["modelValue"]),
        createTextVNode(" selected languages: " + toDisplayString(selectedItems.value), 1 /* TEXT */)
      ]),
      right: withCtx(() => [
        createTextVNode(toDisplayString(` <km-language v-model="selectedItems/>  `))
      ]),
      _: 1 /* STABLE */
    }),
    createVNode(script$6, { "card-header": "Government selector" }, {
      left: withCtx(() => [
        createVNode(script$4, {
          modelValue: selectedItems.value,
          "onUpdate:modelValue": _cache[1] || (_cache[1] = $event => ((selectedItems).value = $event))
        }, null, 8 /* PROPS */, ["modelValue"]),
        createTextVNode(" selected government: " + toDisplayString(selectedItems.value), 1 /* TEXT */)
      ]),
      right: withCtx(() => [
        createTextVNode(toDisplayString(`<km-government v-model="selectedItems"/>  `))
      ]),
      _: 1 /* STABLE */
    })
  ]))
