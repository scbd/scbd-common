  ...
  return (vue.openBlock(), vue.createElementBlock("div", _hoisted_1$6, [
    vue.createElementVNode("div", _hoisted_2$3, [
      vue.createElementVNode("div", _hoisted_3$2, [
        vue.createElementVNode("div", _hoisted_4$1, vue.toDisplayString(_ctx.$attrs["card-header"]), 1 /* TEXT */),
  ...
  return (vue.openBlock(), vue.createBlock(vue.unref(VueMultiselect__default["default"]), {
    ...
    default: vue.withCtx(() => [
      vue.renderSlot(_ctx.$slots, "clear", {}, () => [
        vue.createElementVNode("template", _hoisted_1$5, [
...
var script = {
  ...
  setup(__props) {
    ...
    const selectedItems = vue.ref({ "identifier": "ag" });

return (_ctx, _cache) => {
  return (vue.openBlock(), vue.createElementBlock("div", null, [
    _hoisted_1,
    vue.createVNode(script$6, { "card-header": "Language selector" }, {
      left: vue.withCtx(() => [
        ...
        vue.createTextVNode(" selected languages: " + vue.toDisplayString(selectedItems.value), 1 /* TEXT */)
      ]),
      right: vue.withCtx(() => [
        vue.createTextVNode(vue.toDisplayString(` <km-language v-model="selectedItems/>  `))
      ]),
      _: 1 /* STABLE */
    }),
    vue.createVNode(script$6, { "card-header": "Government selector" }, {
      left: vue.withCtx(() => [
        vue.createVNode(script$4, {
          modelValue: selectedItems.value,
          "onUpdate:modelValue": _cache[1] || (_cache[1] = $event => ((selectedItems).value = $event))
        }, null, 8 /* PROPS */, ["modelValue"]),
        vue.createTextVNode(" selected government: " + vue.toDisplayString(selectedItems.value), 1 /* TEXT */)
      ]),
      right: vue.withCtx(() => [
        vue.createTextVNode(vue.toDisplayString(`<km-government v-model="selectedItems"/>  `))
      ]),
      _: 1 /* STABLE */
    })
  ]))
