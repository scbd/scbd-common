(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('vue'), require('webui-popover'), require('webui-popover/dist/jquery.webui-popover.css'), require('jquery'), require('vue-multiselect'), require('lodash'), require('@/services/composables/i18n'), require('@/services/filters/lstring'), require('@/services/composables/thesaurus')) : typeof define === 'function' && define.amd ? define(['vue', 'webui-popover', 'webui-popover/dist/jquery.webui-popover.css', 'jquery', 'vue-multiselect', 'lodash', '@/services/composables/i18n', '@/services/filters/lstring', '@/services/composables/thesaurus'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.ScbdCommonComponentsSelectorsKmLanguage = factory(global.vue, null, null, global.$, global.VueMultiselect, global._, global.i18n, global.lstring, global.thesaurus));
})(this, function (vue, webuiPopover, jquery_webuiPopover_css, $, VueMultiselect, _, i18n, lstring, thesaurus) {
  'use strict';
    ...
    setup(__props, _ref2) {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("div", _hoisted_1, [vue.createVNode(script$1, {
          ...
          default: vue.withCtx(() => [vue.createVNode(script$1, {
...
//# sourceMappingURL=km-language.umd.js.map
