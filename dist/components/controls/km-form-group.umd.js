(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('vue'), require('webui-popover'), require('webui-popover/dist/jquery.webui-popover.css'), require('jquery')) : typeof define === 'function' && define.amd ? define(['vue', 'webui-popover', 'webui-popover/dist/jquery.webui-popover.css', 'jquery'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.ScbdCommonComponentsControlsKmFormGroup = factory(global.vue, null, null, global.$));
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [vue.createElementVNode("span", {
          ...
          class: "show-pop",
          "data-animation": "pop"
        }, [vue.renderSlot(_ctx.$slots, "default"), vue.renderSlot(_ctx.$slots, "icon", {}, () => [vue.createTextVNode(vue.toDisplayString(" ")), !vue.unref(slots).icon && !vue.unref(slots).default ? (vue.openBlock(), vue.createElementBlock("i", _hoisted_1$1)) : vue.createCommentVNode("v-if", true)])], 512 /* NEED_PATCH */), vue.createElementVNode("div", _hoisted_2$1, [vue.renderSlot(_ctx.$slots, "content", {}, () => [vue.createElementVNode("div", {
  ...
  var script = {
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        ...
        }, vue.toDisplayString(__props.caption), 9 /* TEXT, PROPS */, _hoisted_2)) : vue.createCommentVNode("v-if", true), __props.helpContent ? (vue.openBlock(), vue.createBlock(script$1, {
          key: 1,
          title: __props.helpTitle,
          content: __props.helpContent,
          class: "ms-1 me-1"
        }, null, 8 /* PROPS */, ["title", "content"])) : vue.createCommentVNode("v-if", true), vue.createElementVNode("div", null, [vue.renderSlot(_ctx.$slots, "default")])], 10 /* CLASS, PROPS */, _hoisted_1);
      };
    }
  };
...
//# sourceMappingURL=km-form-group.umd.js.map
