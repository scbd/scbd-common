import { ref, openBlock, createElementBlock, toDisplayString, createCommentVNode, createTextVNode, unref, renderSlot, createElementVNode, normalizeClass, createVNode } from 'vue';
import 'lodash';
...
const _hoisted_1$1 = { class: "scbd-controls km-term" };
const _hoisted_2$1 = {
  key: 0,
...
return (_ctx, _cache) => {
  return (openBlock(), createElementBlock("span", _hoisted_1$1, [
    (error.value)
      ? (openBlock(), createElementBlock("div", _hoisted_2$1, "Error loading term " + toDisplayString(__props.value.identifier), 1 /* TEXT */))
...
//# sourceMappingURL=km-value-term.js.map
