(function (global, factory) {
  ...
  var script$1 = {
    ...
    setup(__props, _ref) {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("span", _hoisted_1$1, [error.value ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2$1, "Error loading term " + vue.toDisplayString(__props.value.identifier), 1 /* TEXT */)) : vue.createCommentVNode("v-if", true), vue.createTextVNode(" " + vue.toDisplayString(vue.unref(lstring)(term.value, __props.locale)) + " ", 1 /* TEXT */), vue.renderSlot(_ctx.$slots, "help", {
          term: term.value
        })]);
      };
    }
  };
  script$1.__scopeId = "data-v-35cfd734";
  script$1.__file = "src/components/controls/view/km-term.vue";
  const _hoisted_1 = ["id"];
  ...
  var script = {
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        ...
        }, null, 8 /* PROPS */, ["value", "locale"])], 8 /* PROPS */, _hoisted_2)], 2 /* CLASS */)], 8 /* PROPS */, _hoisted_1);
      };
    }
  };
  script.__scopeId = "data-v-49bcf87c";
  script.__file = "src/components/controls/view/km-value-term.vue";
  return script;
});
//# sourceMappingURL=km-value-term.umd.js.map
