(function (global, factory) {
  ...
  var script = {
    ...
    setup(__props, _ref) {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("span", _hoisted_1, [error.value ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2, "Error loading term " + vue.toDisplayString(__props.value.identifier), 1 /* TEXT */)) : vue.createCommentVNode("v-if", true), vue.createTextVNode(" " + vue.toDisplayString(vue.unref(lstring)(term.value, __props.locale)) + " ", 1 /* TEXT */), vue.renderSlot(_ctx.$slots, "help", {
          term: term.value
        })]);
      };
    }
...
//# sourceMappingURL=km-term.umd.js.map
