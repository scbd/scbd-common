...
return (_ctx, _cache) => {
  return (vue.openBlock(), vue.createElementBlock("span", _hoisted_1, [
    (error.value)
      ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2, "Error loading term " + vue.toDisplayString(__props.value.identifier), 1 /* TEXT */))
...
//# sourceMappingURL=km-term.cjs.map
