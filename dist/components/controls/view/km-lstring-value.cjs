    ...
    vue.createElementVNode("div", {
      ...
      (__props.type === 'string')
        ? (vue.openBlock(), vue.createElementBlock("div", {
          ...
          }, vue.toDisplayString(valueLstring.value), 9 /* TEXT, PROPS */, _hoisted_2))
        : (__props.type === 'html')
          ? (vue.openBlock(), vue.createElementBlock("div", {
              key: 1,
      ...
      vue.createElementVNode("span", _hoisted_4, [
        vue.createElementVNode("div", {
          ...
          vue.createElementVNode("span", _hoisted_6, vue.toDisplayString(valueLocale.value.toUpperCase()), 1 /* TEXT */)
        ], 8 /* PROPS */, _hoisted_5)
      ])
    ], 2 /* CLASS */)
  ], 8 /* PROPS */, _hoisted_1))
...
//# sourceMappingURL=km-lstring-value.cjs.map
