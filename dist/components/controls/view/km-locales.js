import { mergeModels, useModel, ref, watch, openBlock, createElementBlock, Fragment, renderList, normalizeClass, createElementVNode, unref, toDisplayString } from 'vue';
import 'lodash';
    ...
    (openBlock(true), createElementBlock(Fragment, null, renderList(__props.locales, (locale) => {
      return (openBlock(), createElementBlock("button", {
        ...
        createElementVNode("div", {
          ...
          title: unref(lstring)(getTerm(locale), appLocale.value)
        }, [
          createElementVNode("span", _hoisted_4, toDisplayString(locale.toUpperCase()), 1 /* TEXT */)
        ], 8 /* PROPS */, _hoisted_3)
...
//# sourceMappingURL=km-locales.js.map
