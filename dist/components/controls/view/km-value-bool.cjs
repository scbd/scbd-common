  ...
  return (vue.openBlock(), vue.createElementBlock("div", {
    ...
    vue.createElementVNode("div", {
      ...
      vue.createElementVNode("div", {
        ...
        (__props.value)
          ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_3, vue.toDisplayString(t('yes')), 1 /* TEXT */))
          : (vue.openBlock(), vue.createElementBlock("span", _hoisted_4, vue.toDisplayString(t('no')), 1 /* TEXT */))
      ], 8 /* PROPS */, _hoisted_2),
      vue.createElementVNode("span", _hoisted_5, vue.toDisplayString(__props.locale.toUpperCase()), 1 /* TEXT */)
    ], 2 /* CLASS */)
  ], 8 /* PROPS */, _hoisted_1))
}
}
...
//# sourceMappingURL=km-value-bool.cjs.map
