(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('vue'), require('luxon')) : typeof define === 'function' && define.amd ? define(['vue', 'luxon'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.ScbdCommonComponentsControlsKmNotes = factory(global.vue, global.luxon));
})(this, function (vue, luxon) {
  'use strict';
  ...
  var script = {
    ...
    setup(__props) {
      ...
      let notes = vue.computed(() => {
        if (model.value) return JSON.parse(model.value).filter(e => e != lastNote);
        return [];
      });
      ...
      const save = () => {
        ...
        if (lNotes.at(-1) == lastNote) lNotes.pop();

        // generate new note
        const timestamp = format(new Date(), "FF");
        var newLNote = newNote.value ? "[ ".concat(user.value.name, " | ").concat(timestamp, " ] - ").concat(newNote.value.trim()) : "";
        lastNote = newLNote;
      ...
      return (_ctx, _cache) => {
        var _vue$unref;
        return vue.openBlock(), vue.createElementBlock("div", null, [vue.withDirectives(vue.createElementVNode("textarea", {
          ...
          onChange: save
        }, "\r\n        ", 42 /* CLASS, PROPS, NEED_HYDRATION */, _hoisted_1), [[vue.vModelText, newNote.value]]), (_vue$unref = vue.unref(notes)) !== null && _vue$unref !== void 0 && _vue$unref.length ? (vue.openBlock(), vue.createElementBlock("table", _hoisted_2, [vue.createElementVNode("tbody", null, [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(vue.unref(notes), (item, index) => {
          return vue.openBlock(), vue.createElementBlock("tr", {
            key: index
          }, [vue.createElementVNode("td", null, vue.toDisplayString(item), 1 /* TEXT */), vue.createElementVNode("td", null, [vue.createElementVNode("span", {
            class: "btn float-end",
...
//# sourceMappingURL=km-notes.umd.js.map
