...
const _hoisted_10 = /*#__PURE__*/vue.createElementVNode("i", { class: "bi bi-pencil-square" }, null, -1 /* HOISTED */);
const _hoisted_11 = [
  _hoisted_10
];
const _hoisted_12 = ["onClick"];
const _hoisted_13 = /*#__PURE__*/vue.createElementVNode("i", { class: "bi bi-trash3" }, null, -1 /* HOISTED */);
const _hoisted_14 = [
  _hoisted_13
];
          ...
          vue.createElementVNode("tbody", null, [
            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(vue.unref(links), (item, index) => {
              return (vue.openBlock(), vue.createElementBlock("tr", { key: index }, [
                vue.createElementVNode("td", _hoisted_3, [
                ...
                vue.createElementVNode("td", _hoisted_4, [
                  vue.createElementVNode("a", {
                    href: item.url
                  }, vue.toDisplayString(item.name), 9 /* TEXT, PROPS */, _hoisted_5)
                ]),
                vue.createElementVNode("td", _hoisted_6, [
                  (item.tag)
                    ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_7, " (" + vue.toDisplayString(item.tag) + ") ", 1 /* TEXT */))
                    : vue.createCommentVNode("v-if", true)
                ]),
                vue.createElementVNode("td", _hoisted_8, [
...
//# sourceMappingURL=km-view-links.cjs.map
