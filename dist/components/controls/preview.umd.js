...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('vue'), require('lodash'), require('webui-popover'), require('webui-popover/dist/jquery.webui-popover.css'), require('jquery'), require('@/services/composables/i18n'), require('@/services/filters/lstring'), require('vue-multiselect'), require('@ckeditor/ckeditor5-vue/dist/ckeditor.js'), require('@ckeditor/ckeditor5-vue'), require('@scbd/ckeditor5-build-inline-full/build/ckeditor.js'), require('@scbd/ckeditor5-build-inline-full/build/ckeditor.css'), require('axios'), require('@/services/composables/thesaurus'), require('@/services/util/index')) : typeof define === 'function' && define.amd ? define(['vue', 'lodash', 'webui-popover', 'webui-popover/dist/jquery.webui-popover.css', 'jquery', '@/services/composables/i18n', '@/services/filters/lstring', 'vue-multiselect', '@ckeditor/ckeditor5-vue/dist/ckeditor.js', '@ckeditor/ckeditor5-vue', '@scbd/ckeditor5-build-inline-full/build/ckeditor.js', '@scbd/ckeditor5-build-inline-full/build/ckeditor.css', 'axios', '@/services/composables/thesaurus', '@/services/util/index'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.ScbdCommonComponentsControlsPreview = factory(global.Vue, global._, null, null, global.$, null, null, global.VueMultiselect, null, global.CKEditor, global.ClassicEditor, null, global.axios, global.thesaurus, global.index));
})(this, function (Vue, _, webuiPopover, jquery_webuiPopover_css, $, i18n, lstring$2, VueMultiselect, ckeditor_js, CKEditor, ClassicEditor, ckeditor_css, axios, thesaurus, index) {
  'use strict';
  ...
  var script$o = {
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return Vue.openBlock(), Vue.createElementBlock("div", _hoisted_1$n, [Vue.renderSlot(_ctx.$slots, "default"), (Vue.openBlock(true), Vue.createElementBlock(Vue.Fragment, null, Vue.renderList(__props.locales, locale => {
          ...
          }, null, 40 /* PROPS, NEED_HYDRATION */, _hoisted_2$h)), [[Vue.vModelText, model.value[locale]]]) : Vue.createCommentVNode("v-if", true), __props.rows > 1 ? Vue.withDirectives((Vue.openBlock(), Vue.createElementBlock("textarea", {
            key: 1,
            rows: __props.rows,
            class: "form-control",
            placeholder: __props.placeholder,
          ...
          }, null, 40 /* PROPS, NEED_HYDRATION */, _hoisted_3$d)), [[Vue.vModelText, model.value[locale]]]) : Vue.createCommentVNode("v-if", true), Vue.createElementVNode("div", _hoisted_4$c, [Vue.createElementVNode("button", {
          ...
          }, Vue.toDisplayString(locale.toUpperCase()), 9 /* TEXT, PROPS */, _hoisted_5$b)])], 2 /* CLASS */);
        }), 128 /* KEYED_FRAGMENT */))]);
      };
    }
  };
  ...
  const _hoisted_10$4 = /*#__PURE__*/Vue.createElementVNode("i", {
    class: "bi bi-pencil-square"
  }, null, -1 /* HOISTED */);
  const _hoisted_11$4 = [_hoisted_10$4];
  const _hoisted_12$4 = ["onClick"];
  const _hoisted_13$4 = /*#__PURE__*/Vue.createElementVNode("i", {
    class: "bi bi-trash3"
  }, null, -1 /* HOISTED */);
  const _hoisted_14$4 = [_hoisted_13$4];
  var script$n = {
    ...
    setup(__props, _ref) {
      ...
      return (_ctx, _cache) => {
        var _Vue$unref;
        return Vue.openBlock(), Vue.createElementBlock("div", _hoisted_1$m, [(_Vue$unref = Vue.unref(links)) !== null && _Vue$unref !== void 0 && _Vue$unref.length ? (Vue.openBlock(), Vue.createElementBlock("table", _hoisted_2$g, [Vue.createElementVNode("tbody", null, [(Vue.openBlock(true), Vue.createElementBlock(Vue.Fragment, null, Vue.renderList(Vue.unref(links), (item, index) => {
          return Vue.openBlock(), Vue.createElementBlock("tr", {
            key: index
          }, [Vue.createElementVNode("td", _hoisted_3$c, [Vue.createElementVNode("span", null, Vue.toDisplayString(Vue.unref(languages)[item.language]), 1 /* TEXT */)]), Vue.createElementVNode("td", _hoisted_4$b, [Vue.createElementVNode("a", {
            href: item.url
          }, Vue.toDisplayString(item.name), 9 /* TEXT, PROPS */, _hoisted_5$a)]), Vue.createElementVNode("td", _hoisted_6$8, [item.tag ? (Vue.openBlock(), Vue.createElementBlock("span", _hoisted_7$5, " (" + Vue.toDisplayString(item.tag) + ") ", 1 /* TEXT */)) : Vue.createCommentVNode("v-if", true)]), Vue.createElementVNode("td", _hoisted_8$5, [Vue.createElementVNode("button", {
            class: "btn btn-outline-secondary",
            onClick: $event => edit(index)
          }, [..._hoisted_11$4], 8 /* PROPS */, _hoisted_9$5), Vue.createElementVNode("button", {
            class: "btn btn-outline-secondary",
  ...
  const _hoisted_6$7 = /*#__PURE__*/Vue.createElementVNode("span", {
    "aria-hidden": "true"
  }, "×", -1 /* HOISTED */);
  const _hoisted_7$4 = [_hoisted_6$7];
  const _hoisted_8$4 = {
    class: "modal-body"
  };
  const _hoisted_9$4 = /*#__PURE__*/Vue.createElementVNode("div", {
    class: "alert alert-info"
  }, [/*#__PURE__*/Vue.createTextVNode("Please provide the URL of the website (e.g. "), /*#__PURE__*/Vue.createElementVNode("a", {
    rel: "noopener",
    "translation-url": "",
    target: "_blank",
    href: "http://www.cbd.int"
  }, "https://www.cbd.int"), /*#__PURE__*/Vue.createTextVNode(" )and the name of the website (e.g. \"The Convention on Biological Diversity\"). ")], -1 /* HOISTED */);
  const _hoisted_10$3 = {
    class: "mb-3"
  };
  const _hoisted_11$3 = /*#__PURE__*/Vue.createElementVNode("label", {
    ...
    for: "url"
  }, [/*#__PURE__*/Vue.createTextVNode("Url "), /*#__PURE__*/Vue.createElementVNode("span", {
    class: "text-danger"
  }, " *")], -1 /* HOISTED */);
  const _hoisted_12$3 = /*#__PURE__*/Vue.createElementVNode("br", null, null, -1 /* HOISTED */);
  const _hoisted_13$3 = /*#__PURE__*/Vue.createElementVNode("small", {
    class: "help-block"
  }, "Protocol is required (https:// or http://)", -1 /* HOISTED */);
  const _hoisted_14$3 = {
    key: 0
  };
  const _hoisted_15$2 = /*#__PURE__*/Vue.createElementVNode("span", {
    class: "text-danger"
  }, " Please provide valid URL", -1 /* HOISTED */);
  const _hoisted_16$2 = [_hoisted_15$2];
  const _hoisted_17$2 = {
    class: "mb-3"
  };
  ...
  const _hoisted_20$2 = /*#__PURE__*/Vue.createElementVNode("label", {
    for: "language",
    class: "col-form-label"
  }, [/*#__PURE__*/Vue.createTextVNode("Language "), /*#__PURE__*/Vue.createElementVNode("span", {
    class: "text-danger"
  }, " *")], -1 /* HOISTED */);
  ...
  const _hoisted_23$1 = /*#__PURE__*/Vue.createElementVNode("span", {
    class: "text-danger"
  }, " Please select Language ", -1 /* HOISTED */);
  ...
  var script$m = {
    ...
    setup(__props, _ref2) {
      ...
      const link = Vue.ref({});
      const emit = __emit;
      const isUrlValid = Vue.computed(() => {
        return isValidHttpUrl(link.value.url);
      });
      const isLangValid = Vue.computed(() => {
        var _link$value;
        return !!((_link$value = link.value) !== null && _link$value !== void 0 && (_link$value = _link$value.language) !== null && _link$value !== void 0 && _link$value.trim()) && Object.keys(languages).includes(link.value.language);
      });
      ...
      return (_ctx, _cache) => {
        return modalOpen.value ? (Vue.openBlock(), Vue.createElementBlock("div", _hoisted_1$l, [Vue.createElementVNode("div", _hoisted_2$f, [Vue.createElementVNode("div", _hoisted_3$b, [Vue.createElementVNode("div", _hoisted_4$a, [Vue.createElementVNode("h3", _hoisted_5$9, [Vue.renderSlot(_ctx.$slots, "modalTitle", {}, () => [Vue.createTextVNode("Editing link")])]), Vue.createElementVNode("button", {
          type: "button",
          class: "close",
          "data-dismiss": "modal",
          "aria-label": "Close",
          onClick: close
        }, [..._hoisted_7$4])]), Vue.createElementVNode("div", _hoisted_8$4, [_hoisted_9$4, Vue.createElementVNode("form", null, [Vue.createElementVNode("div", _hoisted_10$3, [_hoisted_11$3, _hoisted_12$3, _hoisted_13$3, Vue.withDirectives(Vue.createElementVNode("input", {
          class: "form-control",
          id: "url",
          "onUpdate:modelValue": _cache[0] || (_cache[0] = $event => link.value.url = $event),
          type: "url",
          placeholder: " https://www."
        }, null, 512 /* NEED_PATCH */), [[Vue.vModelText, link.value.url]]), checkValidation.value && !isUrlValid.value ? (Vue.openBlock(), Vue.createElementBlock("p", _hoisted_14$3, [..._hoisted_16$2])) : Vue.createCommentVNode("v-if", true)]), Vue.createElementVNode("div", _hoisted_17$2, [_hoisted_18$2, Vue.withDirectives(Vue.createElementVNode("input", {
          class: "form-control",
          id: "name",
          "onUpdate:modelValue": _cache[1] || (_cache[1] = $event => link.value.name = $event),
          type: "text",
          placeholder: "example:SCBD website"
        }, null, 512 /* NEED_PATCH */), [[Vue.vModelText, link.value.name]])]), Vue.createElementVNode("div", _hoisted_19$2, [_hoisted_20$2, Vue.withDirectives(Vue.createElementVNode("select", {
          class: "form-select",
          name: "language",
          id: "language",
        ...
        }), 128 /* KEYED_FRAGMENT */))], 512 /* NEED_PATCH */), [[Vue.vModelSelect, link.value.language]]), checkValidation.value && !isLangValid.value ? (Vue.openBlock(), Vue.createElementBlock("p", _hoisted_22$1, [..._hoisted_24$1])) : Vue.createCommentVNode("v-if", true)])])]), Vue.createElementVNode("div", {
          class: "modal-footer"
        }, [Vue.createElementVNode("button", {
          type: "button",
          class: "btn btn-secondary",
          onClick: close
        }, "Cancel"), Vue.createElementVNode("button", {
          type: "button",
          class: "btn btn-primary",
          onClick: save
        }, "Save")])])])])) : Vue.createCommentVNode("v-if", true);
      };
    }
  };
  ...
  var script$l = {
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return Vue.openBlock(), Vue.createElementBlock(Vue.Fragment, null, [Vue.createElementVNode("button", {
          type: "button",
          class: "btn btn-primary",
          onClick: _cache[0] || (_cache[0] = $event => addLink())
        }, [Vue.renderSlot(_ctx.$slots, "link-button-label", {}, () => [Vue.createTextVNode("+ Add Link")])]), Vue.createVNode(script$m, {
          ref_key: "linkEditorRef",
          ref: linkEditorRef,
          onOnClose: onLinkEditorClose
        }, {
          modalTitle: Vue.withCtx(() => [Vue.renderSlot(_ctx.$slots, "link-dialog-title", {}, () => [Vue.createTextVNode(" Edit link ")])]),
          _: 3 /* FORWARDED */
        }, 512 /* NEED_PATCH */), Vue.renderSlot(_ctx.$slots, "links-view", {}, () => [Vue.createVNode(script$n, {
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return Vue.openBlock(), Vue.createElementBlock(Vue.Fragment, null, [Vue.createElementVNode("span", {
          ...
          class: "show-pop",
          "data-animation": "pop"
        }, [Vue.renderSlot(_ctx.$slots, "default"), Vue.renderSlot(_ctx.$slots, "icon", {}, () => [Vue.createTextVNode(Vue.toDisplayString(" ")), !Vue.unref(slots).icon && !Vue.unref(slots).default ? (Vue.openBlock(), Vue.createElementBlock("i", _hoisted_1$k)) : Vue.createCommentVNode("v-if", true)])], 512 /* NEED_PATCH */), Vue.createElementVNode("div", _hoisted_2$e, [Vue.renderSlot(_ctx.$slots, "content", {}, () => [Vue.createElementVNode("div", {
          innerHTML: __props.content
        }, null, 8 /* PROPS */, _hoisted_3$a)])])], 64 /* STABLE_FRAGMENT */);
      };
    }
  };
  ...
  var script$j = {
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        ...
        }, Vue.toDisplayString(__props.caption), 9 /* TEXT, PROPS */, _hoisted_2$d)) : Vue.createCommentVNode("v-if", true), __props.helpContent ? (Vue.openBlock(), Vue.createBlock(script$k, {
          key: 1,
          title: __props.helpTitle,
          content: __props.helpContent,
          class: "ms-1 me-1"
        }, null, 8 /* PROPS */, ["title", "content"])) : Vue.createCommentVNode("v-if", true), Vue.createElementVNode("div", null, [Vue.renderSlot(_ctx.$slots, "default")])], 10 /* CLASS, PROPS */, _hoisted_1$j);
      };
    }
  };
  ...
  var script$i = {
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        ...
        }, Vue.toDisplayString(valueLstring.value), 9 /* TEXT, PROPS */, _hoisted_2$c)) : __props.type === 'html' ? (Vue.openBlock(), Vue.createElementBlock("div", {
          key: 1,
          class: "form-control km-value km-value-lstring-html ck-content",
          dir: Vue.unref(direction)(valueLstring.value, __props.locale),
          innerHTML: valueLstring.value
        }, null, 8 /* PROPS */, _hoisted_3$9)) : Vue.createCommentVNode("v-if", true), Vue.createElementVNode("span", _hoisted_4$9, [Vue.createElementVNode("div", {
          "data-toggle": "tooltip",
          "data-placement": "top",
          title: Vue.unref(lstring$1)(getTerm.value.title, __props.locale)
        }, [Vue.createElementVNode("span", _hoisted_6$6, Vue.toDisplayString(valueLocale.value.toUpperCase()), 1 /* TEXT */)], 8 /* PROPS */, _hoisted_5$8)])], 2 /* CLASS */)], 8 /* PROPS */, _hoisted_1$i);
      };
    }
  };
  ...
  var script$h = {
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        ...
        }, [__props.value ? (Vue.openBlock(), Vue.createElementBlock("span", _hoisted_3$8, Vue.toDisplayString(t('yes')), 1 /* TEXT */)) : (Vue.openBlock(), Vue.createElementBlock("span", _hoisted_4$8, Vue.toDisplayString(t('no')), 1 /* TEXT */))], 8 /* PROPS */, _hoisted_2$b), Vue.createElementVNode("span", _hoisted_5$7, Vue.toDisplayString(__props.locale.toUpperCase()), 1 /* TEXT */)], 2 /* CLASS */)], 8 /* PROPS */, _hoisted_1$h);
      };
    }
  };
  ...
  var script$g = {
    ...
    setup(__props) {
      return (_ctx, _cache) => {
        ...
        }, [Vue.renderSlot(_ctx.$slots, "default", {}, () => [Vue.createTextVNode(Vue.toDisplayString(__props.value), 1 /* TEXT */)])], 8 /* PROPS */, _hoisted_1$g);
      };
    }
  };
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return Vue.openBlock(), Vue.createElementBlock("div", {
          ...
          }, [Vue.createElementVNode("span", _hoisted_4$7, Vue.toDisplayString(locale.toUpperCase()), 1 /* TEXT */)], 8 /* PROPS */, _hoisted_3$7)], 10 /* CLASS, PROPS */, _hoisted_2$a);
        }), 128 /* KEYED_FRAGMENT */))], 8 /* PROPS */, _hoisted_1$f);
      };
    }
  };
  script$f.__file = "src/components/controls/view/km-locales.vue";
  const _hoisted_1$e = {
    class: "scbd-controls km-term"
  };
  const _hoisted_2$9 = {
    key: 0,
  ...
  var script$e = {
    ...
    setup(__props, _ref3) {
      ...
      if (!((_props$value = props.value) !== null && _props$value !== void 0 && _props$value.identifier) || props.value) {
        try {
          // TODO: Use thesaurus API
          ...
          error.value = error;
          console.error("Error loading term ".concat(value.value), error);
        }
      }
      return (_ctx, _cache) => {
        return Vue.openBlock(), Vue.createElementBlock("span", _hoisted_1$e, [error.value ? (Vue.openBlock(), Vue.createElementBlock("div", _hoisted_2$9, "Error loading term " + Vue.toDisplayString(__props.value.identifier), 1 /* TEXT */)) : Vue.createCommentVNode("v-if", true), Vue.createTextVNode(" " + Vue.toDisplayString(Vue.unref(lstring$1)(term.value, __props.locale)) + " ", 1 /* TEXT */), Vue.renderSlot(_ctx.$slots, "help", {
          term: term.value
        })]);
      };
    }
  ...
  const _hoisted_6$5 = /*#__PURE__*/Vue.createElementVNode("span", {
    "aria-hidden": "true"
  }, "×", -1 /* HOISTED */);
  const _hoisted_7$3 = [_hoisted_6$5];
  const _hoisted_8$3 = {
    class: "modal-body"
  };
  const _hoisted_9$3 = {
  ...
  var script$d = {
    ...
    setup(__props, _ref4) {
      ...
      return (_ctx, _cache) => {
        return modalOpen.value ? (Vue.openBlock(), Vue.createElementBlock("div", _hoisted_1$d, [Vue.createElementVNode("div", _hoisted_2$8, [Vue.createElementVNode("div", _hoisted_3$6, [Vue.createElementVNode("div", _hoisted_4$6, [Vue.createElementVNode("h3", _hoisted_5$6, [Vue.renderSlot(_ctx.$slots, "modalTitle", {}, () => [Vue.createTextVNode("Uploading File")])]), Vue.createElementVNode("button", {
          type: "button",
          class: "close",
          "data-dismiss": "modal",
          "aria-label": "Close",
          onClick: close
        }, [..._hoisted_7$3])]), Vue.createElementVNode("div", _hoisted_8$3, [isAddingNewFile.value ? (Vue.openBlock(), Vue.createElementBlock("div", _hoisted_9$3, [isUploadingError.value ? (Vue.openBlock(), Vue.createElementBlock("div", _hoisted_10$2, [..._hoisted_12$2])) : Vue.createCommentVNode("v-if", true), Vue.createElementVNode("div", null, [Vue.createElementVNode("label", null, [Vue.createTextVNode("Uploading "), Vue.createElementVNode("span", null, Vue.toDisplayString(link.value.name), 1 /* TEXT */)]), _hoisted_13$2])])) : Vue.createCommentVNode("v-if", true), Vue.createElementVNode("form", null, [Vue.createElementVNode("div", _hoisted_14$2, [_hoisted_15$1, Vue.withDirectives(Vue.createElementVNode("input", {
          class: "form-control",
          id: "name",
          "onUpdate:modelValue": _cache[0] || (_cache[0] = $event => link.value.name = $event),
          type: "text",
          placeholder: "example:SCBD website"
        }, null, 512 /* NEED_PATCH */), [[Vue.vModelText, link.value.name]])]), Vue.createElementVNode("div", _hoisted_16$1, [_hoisted_17$1, Vue.withDirectives(Vue.createElementVNode("select", {
          class: "form-select",
          name: "language",
          id: "language",
        ...
        }), 128 /* KEYED_FRAGMENT */))], 512 /* NEED_PATCH */), [[Vue.vModelSelect, link.value.language]])]), Vue.createElementVNode("div", _hoisted_19$1, [_hoisted_20$1, Vue.withDirectives(Vue.createElementVNode("input", {
          class: "form-control",
          id: "tag",
          "onUpdate:modelValue": _cache[2] || (_cache[2] = $event => link.value.tag = $event),
          type: "text",
          placeholder: "example: Biodiversity, Aichi target"
        }, null, 512 /* NEED_PATCH */), [[Vue.vModelText, link.value.tag]])])])]), Vue.createElementVNode("div", {
          class: "modal-footer"
        }, [Vue.createElementVNode("button", {
          type: "button",
          class: "btn btn-secondary",
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        ...
        return Vue.openBlock(), Vue.createElementBlock("div", {
          ...
          class: "form-control km-value",
          dir: Vue.unref(direction)((_termValue$value = termValue.value) === null || _termValue$value === void 0 ? void 0 : _termValue$value.title, __props.locale)
        }, [Vue.createVNode(script$e, {
          value: __props.value,
          locale: __props.locale,
          onOnTermLoad: onTermLoad
        }, null, 8 /* PROPS */, ["value", "locale"])], 8 /* PROPS */, _hoisted_2$7)], 2 /* CLASS */)], 8 /* PROPS */, _hoisted_1$c);
      };
    }
  };
  ...
  var script$b = {
    ...
    setup(__props) {
      return (_ctx, _cache) => {
        ...
        }), 128 /* KEYED_FRAGMENT */))], 8 /* PROPS */, _hoisted_1$b);
      };
    }
  };
  ...
  function render(_ctx, _cache) {
    return Vue.openBlock(), Vue.createElementBlock("div", _hoisted_1$a, [Vue.createElementVNode("div", _hoisted_2$6, [Vue.createElementVNode("div", _hoisted_3$5, [Vue.createElementVNode("div", _hoisted_4$5, Vue.toDisplayString(_ctx.$attrs["card-header"]), 1 /* TEXT */), Vue.createElementVNode("div", _hoisted_5$5, [Vue.createElementVNode("div", _hoisted_6$4, [Vue.createElementVNode("div", _hoisted_7$2, [Vue.renderSlot(_ctx.$slots, "left")], 512 /* NEED_PATCH */), Vue.createElementVNode("div", _hoisted_8$2, [Vue.createElementVNode("div", _hoisted_9$2, [Vue.createElementVNode("code", null, [Vue.renderSlot(_ctx.$slots, "right")])])])])])])])]);
  }
  const script$a = {};
    ...
    setup(__props, _ref5) {
      ...
      return (_ctx, _cache) => {
        return Vue.openBlock(), Vue.createBlock(Vue.unref(VueMultiselect__default["default"]), {
          ...
          default: Vue.withCtx(() => [Vue.renderSlot(_ctx.$slots, "clear", {}, () => [Vue.createElementVNode("template", _hoisted_1$9, [Vue.unref(selectItems).length && !__props.disabled ? (Vue.openBlock(), Vue.createElementBlock("div", {
            key: 0,
  ...
  var script$8 = {
    ...
    setup(__props, _ref6) {
      ...
      const selectFile = () => {
        ...
        fileInput.addEventListener('change', _ref7 => {
          let {
            target
          } = _ref7;
      ...
      return (_ctx, _cache) => {
        ...
        }, [Vue.renderSlot(_ctx.$slots, "default")], 8 /* PROPS */, _hoisted_1$8);
      };
    }
  };
  script$8.__file = "src/components/inputs/select-file-button.vue";
  const _hoisted_1$7 = {
    class: "scbd-common km-add-file"
  };
  var script$7 = {
    __name: 'km-add-file',
    props: /*#__PURE__*/Vue.mergeModels({
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return Vue.openBlock(), Vue.createElementBlock("div", _hoisted_1$7, [Vue.createVNode(script$8, {
          onOnFileSelected: receiveFile
        }, {
          default: Vue.withCtx(() => [Vue.renderSlot(_ctx.$slots, "file-button-label", {}, () => [Vue.createTextVNode("+ Add Files")])]),
          _: 3 /* FORWARDED */
          ...
          modalTitle: Vue.withCtx(() => [Vue.renderSlot(_ctx.$slots, "link-dialog-title", {}, () => [Vue.createTextVNode(" File Upload ")])]),
          _: 3 /* FORWARDED */
        }, 512 /* NEED_PATCH */), Vue.renderSlot(_ctx.$slots, "links-view", {}, () => [Vue.createVNode(script$n, {
          modelValue: links.value,
  ...
  var script$6 = {
    ...
    setup(__props, _ref8) {
      ...
      return (_ctx, _cache) => {
        return Vue.openBlock(), Vue.createElementBlock("div", {
        ...
        }, [Vue.createElementVNode("div", _hoisted_2$5, [Vue.createElementVNode("ul", _hoisted_3$4, [(Vue.openBlock(true), Vue.createElementBlock(Vue.Fragment, null, Vue.renderList(tabs.value, (tab, index) => {
          ...
          }, [Vue.createElementVNode("a", _hoisted_5$4, [Vue.createElementVNode("span", _hoisted_6$3, Vue.toDisplayString(index + 1), 1 /* TEXT */), Vue.createElementVNode("span", _hoisted_7$1, Vue.toDisplayString(tab.title), 1 /* TEXT */)])], 10 /* CLASS, PROPS */, _hoisted_4$4);
        }), 128 /* KEYED_FRAGMENT */))])]), Vue.createElementVNode("div", _hoisted_8$1, [Vue.createElementVNode("form", null, [Vue.renderSlot(_ctx.$slots, "default")])]), Vue.createElementVNode("div", _hoisted_9$1, [Vue.createElementVNode("ul", _hoisted_10$1, [(Vue.openBlock(true), Vue.createElementBlock(Vue.Fragment, null, Vue.renderList(tabs.value, (tab, index) => {
          return Vue.openBlock(), Vue.createElementBlock("li", {
            onClick: Vue.withModifiers($event => selectTab(index), ["prevent", "stop"]),
            class: Vue.normalizeClass(["nav-item", {
              active: tab.isActive
            ...
            key: "tab-".concat(index)
          }, [Vue.createElementVNode("a", _hoisted_12$1, [Vue.createElementVNode("span", _hoisted_13$1, Vue.toDisplayString(index + 1), 1 /* TEXT */), Vue.createElementVNode("span", _hoisted_14$1, Vue.toDisplayString(tab.title), 1 /* TEXT */)])], 10 /* CLASS, PROPS */, _hoisted_11$1);
        }), 128 /* KEYED_FRAGMENT */))])])], 8 /* PROPS */, _hoisted_1$6);
      };
    }
  };
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return __props.isActive ? (Vue.openBlock(), Vue.createElementBlock("div", {
          ...
          id: _ctx.$attrs.id
        }, [Vue.renderSlot(_ctx.$slots, "default")], 8 /* PROPS */, _hoisted_1$5)) : Vue.createCommentVNode("v-if", true);
      };
    }
  };
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return Vue.openBlock(), Vue.createElementBlock("div", {
          ...
          role: "status"
        }, null, 2 /* CLASS */), Vue.renderSlot(_ctx.$slots, "default", {}, () => [__props.message ? (Vue.openBlock(), Vue.createElementBlock("span", _hoisted_1$4, Vue.toDisplayString(__props.message), 1 /* TEXT */)) : Vue.createCommentVNode("v-if", true), !__props.message ? (Vue.openBlock(), Vue.createElementBlock("span", _hoisted_2$4, Vue.toDisplayString(Vue.unref(t)('loading')) + "...", 1 /* TEXT */)) : Vue.createCommentVNode("v-if", true)])], 2 /* CLASS */);
      };
    }
  };
  ...
  var script$3 = {
    ...
    setup(__props) {
      ...
      const props = __props;
      return (_ctx, _cache) => {
        return props.visible ? (Vue.openBlock(), Vue.createElementBlock("div", _hoisted_1$3, [Vue.createElementVNode("div", _hoisted_2$3, [Vue.createElementVNode("div", _hoisted_3$3, [Vue.createElementVNode("div", _hoisted_4$3, [Vue.createElementVNode("h5", _hoisted_5$3, Vue.toDisplayString(props.title || Vue.unref(t)('processing')), 1 /* TEXT */)]), Vue.createElementVNode("div", _hoisted_6$2, [Vue.renderSlot(_ctx.$slots, "default", {}, () => [Vue.createVNode(script$4, {
          message: __props.message || Vue.unref(t)('loading')
        }, null, 8 /* PROPS */, ["message"])])])])])])) : Vue.createCommentVNode("v-if", true);
      };
    }
  };
  ...
  class ApiBase {
    constructor(options) {
      ...
      http.get = async function () {
        return (await loadAsyncHeaders(_this2.config)).get(...arguments);
      };
      http.head = async function () {
        return (await loadAsyncHeaders(_this2.config)).head(...arguments);
      };
      http.post = async function () {
        return (await loadAsyncHeaders(_this2.config)).post(...arguments);
      };
      http.put = async function () {
        return (await loadAsyncHeaders(_this2.config)).put(...arguments);
      };
      http.patch = async function () {
        return (await loadAsyncHeaders(_this2.config)).patch(...arguments);
      };
      http.delete = async function () {
        return (await loadAsyncHeaders(_this2.config)).delete(...arguments);
      };
      http.options = async function () {
        return (await loadAsyncHeaders(_this2.config)).options(...arguments);
      };
      http.request = async function () {
        return (await loadAsyncHeaders(_this2.config)).request(...arguments);
      };
      this.http = http;
    }
  }
  ...
  class KmDocumentsApi extends ApiBase {
    ...
    async put(identifier, body, _ref9) {
      let {
        realm
      } = _ref9;
      if (!isValid(identifier)) throw Error("invalid value for identifier");
    ...
    upload(identifier, file) {
      try {
        ...
        return async function (contentType) {
          ...
          var contentType = params.contentType || _this3.getMimeType(file);
          ...
          ////TEMP////////////////
          //upload to temp url
          const data = _this3.http.put(serviceUrls$1.attachmentUrl(identifier, file.name), body = file, {
            params
          }).then(res => res.data).catch(tryCastToApiError);
          const config = useRuntimeConfig();
  ...
  var script$2 = {
    ...
    setup(__props, _ref10) {
      ...
      return (_ctx, _cache) => {
        return Vue.openBlock(), Vue.createElementBlock("div", null, [editorConfig.value ? (Vue.openBlock(), Vue.createElementBlock("div", _hoisted_1$2, [Vue.createCommentVNode(" <overlay-loading :active=\"isUploadingFile\" \r\n          :can-cancel=\"false\" background-color=\"rgb(9 9 9)\"\r\n          :is-full-page=\"false\">\r\n          <km-spinner size=\"lg\" \r\n              :message=\"t('uploadingFile')\"></km-spinner>\r\n      </overlay-loading>\r\n   "), Vue.createVNode(Vue.unref(ckeditor), {
        ...
        }, null, 8 /* PROPS */, ["modelValue", "editor", "config", "tagName", "disabled"])])) : Vue.createCommentVNode("v-if", true), Vue.createElementVNode("p", _hoisted_2$2, [Vue.createTextVNode(Vue.toDisplayString(Vue.unref(t)('attachmentMessage')) + " ", 1 /* TEXT */), Vue.createElementVNode("span", _hoisted_3$2, [Vue.createElementVNode("strong", null, Vue.toDisplayString(Vue.unref(t)('wordCount')) + ": " + Vue.toDisplayString(wordCount.value), 1 /* TEXT */)])]), uploadErrors.length ? (Vue.openBlock(), Vue.createElementBlock("p", _hoisted_4$2, [Vue.createElementVNode("div", _hoisted_5$2, [Vue.createTextVNode(Vue.toDisplayString(Vue.unref(t)('uploadError')) + " ", 1 /* TEXT */), Vue.createElementVNode("ul", null, [(Vue.openBlock(), Vue.createElementBlock(Vue.Fragment, null, Vue.renderList(uploadErrors, error => {
  ...
  const _hoisted_1$1 = {
    class: "scbd-common km-input-rich-lstring"
  };
  ...
  var script$1 = {
    ...
    setup(__props, _ref11) {
      ...
      const onChange = value => {
        const clean = removeEmpty({
          ...binding.value
        });
        emit('update:modelValue', clean);
      };
      const onFileUpload = _ref12 => {
        let {
          file
        } = _ref12;
        emit('onFileUpload', {
      ...
      const loadLanguages = () => {
        ...
        (_props$locales2 = props.locales) === null || _props$locales2 === void 0 || _props$locales2.forEach(e => {
          thesaurusService.loadDomainTerms("lang-".concat(e));
        });
      };
      const getTerm = term => {
        const thesaurusService = thesaurus.useThesaurus();
        return thesaurusService.getDomainTerms("lang-".concat(term)) || {};
      };
      ...
      return (_ctx, _cache) => {
        return Vue.openBlock(), Vue.createElementBlock("div", _hoisted_1$1, [Vue.createElementVNode("div", {
          id: "km-rich-lstring-".concat(Vue.unref(uid))
        }, [Vue.createElementVNode("ul", _hoisted_3$1, [(Vue.openBlock(true), Vue.createElementBlock(Vue.Fragment, null, Vue.renderList(props.locales, locale => {
          return Vue.openBlock(), Vue.createElementBlock("li", {
            class: "nav-item",
            key: locale,
            id: "lstringTab-".concat(Vue.unref(uid))
          }, [Vue.createElementVNode("a", {
            class: Vue.normalizeClass(["nav-link", {
              'active': selectedLocale.value === locale
            }]),
            "aria-current": "page",
            href: "javascript:void(0);",
            onClick: $event => onTabChange(locale)
          }, Vue.toDisplayString(Vue.unref(lstring)(getTerm(locale).title || locale)), 11 /* TEXT, CLASS, PROPS */, _hoisted_5$1)], 8 /* PROPS */, _hoisted_4$1);
        }), 128 /* KEYED_FRAGMENT */))]), (Vue.openBlock(true), Vue.createElementBlock(Vue.Fragment, null, Vue.renderList(__props.locales, locale => {
          return Vue.openBlock(), Vue.createElementBlock("div", {
            class: Vue.normalizeClass(["mt-2", {
              'd-none': selectedLocale.value != locale
            }]),
            "aria-labelledby": "tabContent-".concat(locale, "-").concat(Vue.unref(uid)),
            key: locale,
            id: "lstringTabContent-".concat(Vue.unref(uid))
          }, [selectedLocale.value == locale ? (Vue.openBlock(), Vue.createBlock(script$2, {
            key: 0,
            modelValue: binding.value[selectedLocale.value],
            "onUpdate:modelValue": [_cache[0] || (_cache[0] = $event => binding.value[selectedLocale.value] = $event), onChange],
            identifier: __props.identifier,
            locale: selectedLocale.value,
            config: Vue.unref(allPluginsConfig),
            onOnFileUpload: onFileUpload
          }, null, 8 /* PROPS */, ["modelValue", "identifier", "locale", "config"])) : Vue.createCommentVNode("v-if", true)], 10 /* CLASS, PROPS */, _hoisted_6$1);
        }), 128 /* KEYED_FRAGMENT */))], 8 /* PROPS */, _hoisted_2$1)]);
      };
    }
  };
  ...
  }, "Email address"), /*#__PURE__*/Vue.createElementVNode("input", {
    type: "email",
    class: "form-control",
  ...
  }, "Password"), /*#__PURE__*/Vue.createElementVNode("input", {
    type: "password",
    class: "form-control",
  ...
  const _hoisted_23 = /*#__PURE__*/Vue.createElementVNode("div", {
    ...
    class: "card-title"
  }, "Card title"), /*#__PURE__*/Vue.createElementVNode("h6", {
    class: "card-subtitle mb-2 text-muted"
  }, "Card subtitle"), /*#__PURE__*/Vue.createElementVNode("p", {
    class: "card-text"
  }, "Some quick example text to build on the card title and make up the bulk of the card's content."), /*#__PURE__*/Vue.createElementVNode("a", {
    href: "#",
    class: "card-link"
  }, "Card link"), /*#__PURE__*/Vue.createElementVNode("a", {
    href: "#",
    class: "card-link"
  ...
  var script = {
    ...
    setup(__props) {
      ...
      const kmAddLinkModel1 = Vue.ref([{
        "url": "http://cbd.int",
        "name": "CBD website",
        "language": "en"
      }]);
      const kmAddLinkModel2 = Vue.ref([]);
      const kmAddFileModel1 = Vue.ref([{
        "url": "http://api.cbd.int/api/2013",
        "name": "report.pdf",
        "language": "en",
        tag: "Biodiversity"
      }]);
      const kmAddFileModel2 = Vue.ref([{
        "url": "http://api.cbd.int/api/2013",
        "name": "report.pdf",
        "language": "en",
        tag: "Biodiversity"
      ...
      const isValid = name => {
        var _validationReview$err;
        console.log(name);
        return !!(validationReview !== null && validationReview !== void 0 && (_validationReview$err = validationReview.errors) !== null && _validationReview$err !== void 0 && _validationReview$err.find(e => e.property == name));
      };

      // link Editor   
      const newLink = Vue.ref({
        url: 'https://cbd.int',
        name: 'CDB website',
        language: 'es'
      });
      ...
      // file upload editor
      const newFile = Vue.ref({
        url: 'https://api/cbd.int/api/2013',
        name: 'report.pdf',
        language: 'en',
        tag: "Biodiversity"
      });
      ...
      return (_ctx, _cache) => {
        ...
        return Vue.openBlock(), Vue.createElementBlock("div", null, [_hoisted_1, Vue.createVNode(script$a, {
          "card-header": "Available locales"
        }, {
          left: Vue.withCtx(() => [Vue.createElementVNode("div", _hoisted_2, [(Vue.openBlock(true), Vue.createElementBlock(Vue.Fragment, null, Vue.renderList(locales.value, (locale, index) => {
            return Vue.openBlock(), Vue.createElementBlock("button", {
              class: "btn btn-danger",
              key: locale,
              onClick: $event => removeLocale(index)
            }, [_hoisted_4, Vue.createTextVNode(" " + Vue.toDisplayString(locale), 1 /* TEXT */)], 8 /* PROPS */, _hoisted_3);
          }), 128 /* KEYED_FRAGMENT */))])]),
          right: Vue.withCtx(() => [Vue.createTextVNode(Vue.toDisplayString("<button class=\"btn btn-danger\" v-for=\"(locale, index) in locales\" :key=\"locale\" @click=\"removeLocale(index)\">\n                    <i class=\"bi bi-trash\"></i></button> "), 1 /* TEXT */)]),
          _: 1 /* STABLE */
        }), Vue.createVNode(script$a, {
          "card-header": "Link editor"
        }, {
          left: Vue.withCtx(() => [Vue.createElementVNode("button", {
            class: "btn btn-default",
            onClick: _cache[0] || (_cache[0] = $event => showLinkEditor())
          }, "Show Link editor"), Vue.createVNode(script$m, {
            ref_key: "linkEditorRef",
            ref: linkEditorRef,
            onOnClose: onLinkEditorClose
          }, null, 512 /* NEED_PATCH */), Vue.createTextVNode(" " + Vue.toDisplayString(newLink.value), 1 /* TEXT */)]),
          right: Vue.withCtx(() => [Vue.createTextVNode(" <button class=\"btn btn-default\" @click=\"showLinkEditor()\">Show Link editor</button> <link-editor ref=\"linkEditorRef\" @close=\"onLinkEditorClose\"></link-editor> ")]),
          _: 1 /* STABLE */
        }), Vue.createVNode(script$a, {
          "card-header": "Km view links"
        }, {
          left: Vue.withCtx(() => [Vue.createVNode(script$n, {
            modelValue: links.value,
            "onUpdate:modelValue": _cache[1] || (_cache[1] = $event => links.value = $event),
            onOnEdit: _cache[2] || (_cache[2] = $event => _ctx.edit($event)),
            onOnDelete: _cache[3] || (_cache[3] = $event => _ctx.remove($event))
          }, null, 8 /* PROPS */, ["modelValue"])]),
          right: Vue.withCtx(() => [Vue.createTextVNode(" <km-view-links v-model=\"links\" @on-edit = \"edit($event)\" @on-delete = \"remove($event)\"></km-view-links> ")]),
          _: 1 /* STABLE */
        }), Vue.createVNode(script$a, {
          "card-header": "Km value bool"
        }, {
          left: Vue.withCtx(() => [Vue.createVNode(script$h, {
            value: "true",
            locale: "en"
          })]),
          right: Vue.withCtx(() => [Vue.createTextVNode(Vue.toDisplayString("<km-value-bool value=\"true\" locale=\"en\"></km-value-bool>"))]),
          _: 1 /* STABLE */
        }), Vue.createVNode(script$a, {
          "card-header": "KmInputLString"
        }, {
          left: Vue.withCtx(() => [Vue.createVNode(script$o, {
            modelValue: kmInputLStringModel.value,
            "onUpdate:modelValue": _cache[4] || (_cache[4] = $event => kmInputLStringModel.value = $event),
            locales: locales.value,
            placeholder: "Please enter ..."
          }, null, 8 /* PROPS */, ["modelValue", "locales"]), _hoisted_5, Vue.createTextVNode(" " + Vue.toDisplayString(kmInputLStringModel.value), 1 /* TEXT */)]),
          right: Vue.withCtx(() => [Vue.createElementVNode("code", null, Vue.toDisplayString("<km-input-lstring v-model=\"kmInputLStringModel\" :locales=\"locales\" placeholder=\"Please enter ...\" >\n                    </km-input-lstring>"), 1 /* TEXT */)]),
          _: 1 /* STABLE */
        }), Vue.createVNode(script$a, {
          "card-header": "KmInputLString "
        }, {
          left: Vue.withCtx(() => [Vue.createVNode(script$o, {
            ...
            rows: "5",
            placeholder: "Please enter ..."
          }, null, 8 /* PROPS */, ["modelValue", "locales"]), _hoisted_6, Vue.createTextVNode(" " + Vue.toDisplayString(kmInputLStringModel.value), 1 /* TEXT */)]),
          right: Vue.withCtx(() => [Vue.createElementVNode("code", null, Vue.toDisplayString("<km-input-lstring v-model=\"kmInputLStringModel\" :locales=\"locales\"  rows=\"5\" placeholder=\"Please enter ...\" >\n                    </km-input-lstring>"), 1 /* TEXT */)]),
          _: 1 /* STABLE */
        }), Vue.createVNode(script$a, {
          "card-header": "Add Link"
        }, {
          left: Vue.withCtx(() => [Vue.createVNode(script$l, {
            modelValue: kmAddLinkModel1.value,
            "onUpdate:modelValue": _cache[6] || (_cache[6] = $event => kmAddLinkModel1.value = $event)
          }, null, 8 /* PROPS */, ["modelValue"]), Vue.createTextVNode("Parent links : " + Vue.toDisplayString(kmAddLinkModel1.value) + " ", 1 /* TEXT */), _hoisted_7]),
          right: Vue.withCtx(() => [Vue.createTextVNode(" <km-add-link/> ")]),
          _: 1 /* STABLE */
        }), Vue.createVNode(script$a, {
          "card-header": "Add Websites"
        }, {
          left: Vue.withCtx(() => [Vue.createVNode(script$l, {
            modelValue: kmAddLinkModel2.value,
            "onUpdate:modelValue": _cache[7] || (_cache[7] = $event => kmAddLinkModel2.value = $event)
          }, {
            "link-button-label": Vue.withCtx(() => [Vue.createTextVNode(" Add Websites ")]),
            "link-dialog-title": Vue.withCtx(() => [Vue.createTextVNode(" My custom title ")]),
            "links-view": Vue.withCtx(() => [_hoisted_8]),
            _: 1 /* STABLE */
          }, 8 /* PROPS */, ["modelValue"]), Vue.createTextVNode(" Parent links : " + Vue.toDisplayString(kmAddLinkModel2.value) + " ", 1 /* TEXT */), _hoisted_9]),
          right: Vue.withCtx(() => [Vue.createTextVNode(" <km-add-link> <template #link-button-label> Add Websites </template> <template #link-dialog-title> my custom title </template> <template #links-view> <p> </p> </template> </km-add-link> ")]),
          _: 1 /* STABLE */
        }), Vue.createVNode(script$a, {
          "card-header": "Km form group"
        }, {
          left: Vue.withCtx(() => [Vue.createVNode(script$j, {
            required: "",
            name: "government",
          ...
          right: Vue.withCtx(() => [Vue.createTextVNode(Vue.toDisplayString(" <km-form-group required name=\"government\" caption=\"SCBD Control help\" help-content=\"This is a preview of simple help, it also supports <h3>html</h3>\">\n                    <input name=\"government-input\" class=\"form-control\" />\n                </km-form-group>    ") + " "), _hoisted_11, _hoisted_12, Vue.createVNode(_component_select_file_button, {
            multiple: "",
            onOnFileSelected: receiveFile
          }, {
            default: Vue.withCtx(() => [Vue.renderSlot(_ctx.$slots, "file-button-label", {}, () => [Vue.createTextVNode("+ Add Multiple File")])]),
            _: 3 /* FORWARDED */
          }), _hoisted_13, _hoisted_14, Vue.createVNode(_component_select_file_button, {
            onOnFileSelected: receiveFile
          }, {
            default: Vue.withCtx(() => [Vue.renderSlot(_ctx.$slots, "file-button-label", {}, () => [Vue.createTextVNode("+ Add File")])]),
            _: 3 /* FORWARDED */
          }), (Vue.openBlock(true), Vue.createElementBlock(Vue.Fragment, null, Vue.renderList(Vue.unref(files), (item, index) => {
            return Vue.openBlock(), Vue.createElementBlock("div", {
              key: index
            }, Vue.toDisplayString(item.name), 1 /* TEXT */);
          }), 128 /* KEYED_FRAGMENT */))]),
          _: 3 /* FORWARDED */
        }), Vue.createVNode(script$a, {
          "card-header": "Km lstring value"
        }, {
          left: Vue.withCtx(() => [Vue.createVNode(script$i, {
            value: "Test Value",
            locale: "en"
          })]),
          right: Vue.withCtx(() => [Vue.createTextVNode(Vue.toDisplayString("<km-lstring-value value=\"Test Value\" locale=\"en\"></km-lstring-value>"))]),
          _: 1 /* STABLE */
        }), Vue.createVNode(script$a, {
          "card-header": "Km Value"
        }, {
          left: Vue.withCtx(() => [Vue.createVNode(script$g, {
            value: "Test Value"
          })]),
          right: Vue.withCtx(() => [Vue.createTextVNode(Vue.toDisplayString("<km-value value=\"Test Value\"></km-value>"))]),
          _: 1 /* STABLE */
        }), Vue.createVNode(script$a, {
          "card-header": "Km Locales"
        }, {
          left: Vue.withCtx(() => [Vue.createTextVNode(Vue.toDisplayString(kmLocalesModel.value) + " ", 1 /* TEXT */), Vue.createVNode(script$f, {
            locales: locales.value,
          ...
          right: Vue.withCtx(() => [Vue.createTextVNode(Vue.toDisplayString("<km-locales :locales=\"locales\" v-model=\"kmLocalesModel\"></km-locales>"))]),
          _: 1 /* STABLE */
        }), Vue.createVNode(script$a, {
          "card-header": "Km Term"
        }, {
          left: Vue.withCtx(() => [Vue.createTextVNode(Vue.toDisplayString(kmInitializeTerm.value) + " ", 1 /* TEXT */), Vue.createVNode(script$e, {
            value: kmTermModel,
            locale: kmLocalesModel.value,
            onOnTermLoad: onTermLoad
          }, null, 8 /* PROPS */, ["locale"])]),
          right: Vue.withCtx(() => [Vue.createTextVNode(Vue.toDisplayString("<km-term\n                    :value=\"kmTermModel\" :locale=\"kmLocalesModel\" @on-term-load=\"onTermLoad\"                                           \n                    >\n                </km-term>"))]),
          _: 1 /* STABLE */
        }), Vue.createVNode(script$a, {
          "card-header": "Km value term"
        }, {
          left: Vue.withCtx(() => [Vue.createTextVNode(Vue.toDisplayString(kmTermModel) + " - " + Vue.toDisplayString(kmLocalesModel.value) + " ", 1 /* TEXT */), Vue.createVNode(script$c, {
            value: kmTermModel,
            locale: kmLocalesModel.value
          }, null, 8 /* PROPS */, ["locale"])]),
          right: Vue.withCtx(() => [Vue.createTextVNode(Vue.toDisplayString(" <km-value-term\n                :value=\"kmTermModel\" :locale=\"kmLocalesModel\"                                          \n                >\n                </km-value-term>"))]),
          _: 1 /* STABLE */
        }), Vue.createVNode(script$a, {
          "card-header": "File Upload Editor"
        }, {
          left: Vue.withCtx(() => [Vue.createElementVNode("button", {
            class: "btn btn-default",
            onClick: _cache[9] || (_cache[9] = $event => showFileUploadEditor())
          }, "Show File Upload editor"), Vue.createVNode(script$d, {
            ref_key: "fileUploadEditorRef",
            ref: fileUploadEditorRef,
            onOnClose: onFileUploadEditorClose
          }, null, 512 /* NEED_PATCH */), Vue.createTextVNode(" " + Vue.toDisplayString(newFile.value), 1 /* TEXT */)]),
          right: Vue.withCtx(() => [Vue.createTextVNode(" <button class=\"btn btn-default\" @click=\"showFileUploadEditor()\">Show File Upload editor</button> <file-upload-editor ref=\"fileUploadEditorRef\" @on-close=\"onFileUploadEditorClose\"></file-upload-editor> ")]),
          _: 1 /* STABLE */
        }), Vue.createVNode(script$a, {
          "card-header": "Km value terms"
        }, {
          left: Vue.withCtx(() => [Vue.createVNode(script$b, {
            value: kmValueTermsModel,
            locale: kmLocalesModel.value
          }, null, 8 /* PROPS */, ["locale"]), _hoisted_15]),
          right: Vue.withCtx(() => [Vue.createTextVNode(Vue.toDisplayString("<km-value-terms :value=\"kmValueTermsModel\" :locale=\"kmLocalesModel\"></km-value-terms>"))]),
          _: 1 /* STABLE */
        }), Vue.createVNode(script$a, {
          "card-header": "Add File"
        }, {
          left: Vue.withCtx(() => [Vue.createVNode(script$7, {
            modelValue: kmAddFileModel1.value,
            "onUpdate:modelValue": _cache[10] || (_cache[10] = $event => kmAddFileModel1.value = $event),
            multiple: false
          }, null, 8 /* PROPS */, ["modelValue"]), _hoisted_16, Vue.createTextVNode("Parent links : " + Vue.toDisplayString(kmAddFileModel1.value) + " ", 1 /* TEXT */), _hoisted_17]),
          right: Vue.withCtx(() => [Vue.createTextVNode(Vue.toDisplayString("<km-add-file v-model=\"kmAddFileModel1\" :multiple=\"false\"/>"))]),
          _: 1 /* STABLE */
        }), Vue.createVNode(script$a, {
          "card-header": "Add File"
        }, {
          left: Vue.withCtx(() => [Vue.createVNode(script$7, {
            ...
            "link-button-label": Vue.withCtx(() => [Vue.createTextVNode(" Add File ")]),
            "link-dialog-title": Vue.withCtx(() => [Vue.createTextVNode(" My custom title ")]),
            "links-view": Vue.withCtx(() => [_hoisted_18]),
            _: 1 /* STABLE */
          }, 8 /* PROPS */, ["modelValue"]), Vue.createTextVNode(" Parent links : " + Vue.toDisplayString(kmAddFileModel2.value) + " ", 1 /* TEXT */), _hoisted_19]),
          right: Vue.withCtx(() => [Vue.createTextVNode(Vue.toDisplayString(" <km-add-file v-model=\"kmAddFileModel2\" >                                                                  \n                    <template #link-button-label>\n                        Add File\n                    </template>\n                    <template #link-dialog-title>\n                        My custom title\n                    </template>                                  \n                    <template #links-view>     \n                        <p></p>                                  \n                    </template> \n                </km-add-file>"))]),
          _: 1 /* STABLE */
        }), Vue.createVNode(script$a, {
          "card-header": "multi-selector"
        }, {
          left: Vue.withCtx(() => [Vue.createVNode(script$9, {
          ...
          }, null, 8 /* PROPS */, ["modelValue", "onOnSearchChange"]), _hoisted_20, Vue.createTextVNode("selected: " + Vue.toDisplayString(selectedItem.value) + " ", 1 /* TEXT */), _hoisted_21]),
          right: Vue.withCtx(() => [Vue.createTextVNode(Vue.toDisplayString("<multi-selector\n                    v-model=\"selectedItem\"       \n                    :options=\"options\"\n                    :label=\"label\"\n                    :value-key=\"valueKey\"\n                    :custom-label=\"customLabel\"\n                    :placeholder = \"placeholder\"\n                    :track-by = \"trackBy\"\n                    :multiple=\"multiple\"\n                    :disabled = \"disabled\"\n                    :open-direction=\"openDirection\" \n                    :searchable=\"searchable\"   \n                    @on-search-change=\"onSearchChange\">                                   \n                </multi-selector> "))]),
          _: 1 /* STABLE */
        }), Vue.createVNode(script$a, {
          "card-header": "Km Form Wizard Tab Content"
        }, {
          left: Vue.withCtx(() => [Vue.createVNode(script$6, {
            onOnTabChange: onChangeCurrentTab
          }, {
            default: Vue.withCtx(() => [Vue.createCommentVNode(" Tab 1 "), Vue.createVNode(script$5, {
              isActive: activeTab.value === 0,
              title: "Tab 1"
            }, {
              default: Vue.withCtx(() => [_hoisted_22]),
              _: 1 /* STABLE */
            }, 8 /* PROPS */, ["isActive"]), Vue.createCommentVNode(" End of Tab 1 "), Vue.createCommentVNode(" Tab 2 "), Vue.createVNode(script$5, {
              isActive: activeTab.value === 1,
              title: "Tab 2"
            }, {
              default: Vue.withCtx(() => [_hoisted_23]),
              _: 1 /* STABLE */
            }, 8 /* PROPS */, ["isActive"]), Vue.createCommentVNode(" End of Tab 2 ")]),
            _: 1 /* STABLE */
          })]),
          right: Vue.withCtx(() => [Vue.createTextVNode(Vue.toDisplayString("\n                    <km-form-wizard-tab-content :isActive=\"activeTab === 0\" title=\"Tab 1\"></km-form-wizard-tab-content>\n                "))]),
          _: 1 /* STABLE */
        }), Vue.createVNode(script$a, {
          "card-header": "Spinner"
        }, {
          left: Vue.withCtx(() => [Vue.createVNode(script$4, {
            variant: "spinner-grow spinner-grow-sm"
          }, {
            default: Vue.withCtx(() => [Vue.createTextVNode("New loading")]),
            _: 1 /* STABLE */
          })]),
          right: Vue.withCtx(() => [_hoisted_24]),
          _: 1 /* STABLE */
        }), Vue.createVNode(script$a, {
          "card-header": "spinner modal"
        }, {
          left: Vue.withCtx(() => [Vue.createVNode(script$3, {
            visible: true,
            title: "Title",
            message: "Please wait"
          })]),
          right: Vue.withCtx(() => [_hoisted_25]),
          _: 1 /* STABLE */
        }), Vue.createVNode(script$a, {
          "card-header": "km input rich lstring"
        }, {
          ...
          }, null, 8 /* PROPS */, ["locales", "modelValue"]), Vue.createTextVNode(" data: " + Vue.toDisplayString(richLstringModel.value), 1 /* TEXT */)]),
          right: Vue.withCtx(() => [_hoisted_26]),
          _: 1 /* STABLE */
        }), Vue.createTextVNode(" - "), Vue.createCommentVNode(" <preview-component card-header=\"Link editor\">\r\n            <template #left></template>\r\n            <template #right>\r\n                <code></code>\r\n            </template>\r\n        </preview-component> ")]);
      };
    }
  };
