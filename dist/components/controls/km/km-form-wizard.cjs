        ...
        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(tabs.value, (tab, index) => {
          return (vue.openBlock(), vue.createElementBlock("li", {
            ...
            vue.createElementVNode("a", _hoisted_5, [
              vue.createElementVNode("span", _hoisted_6, vue.toDisplayString(index + 1), 1 /* TEXT */),
              vue.createElementVNode("span", _hoisted_7, vue.toDisplayString(tab.title), 1 /* TEXT */)
            ])
      ...
      vue.createElementVNode("ul", _hoisted_10, [
        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(tabs.value, (tab, index) => {
          return (vue.openBlock(), vue.createElementBlock("li", {
            ...
            vue.createElementVNode("a", _hoisted_12, [
              vue.createElementVNode("span", _hoisted_13, vue.toDisplayString(index + 1), 1 /* TEXT */),
              vue.createElementVNode("span", _hoisted_14, vue.toDisplayString(tab.title), 1 /* TEXT */)
            ])
...
//# sourceMappingURL=km-form-wizard.cjs.map
