...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('vue'), require('lodash'), require('@ckeditor/ckeditor5-vue/dist/ckeditor.js'), require('@ckeditor/ckeditor5-vue'), require('@scbd/ckeditor5-build-inline-full/build/ckeditor.js'), require('@scbd/ckeditor5-build-inline-full/build/ckeditor.css'), require('@/services/composables/i18n'), require('@/services/filters/lstring'), require('axios'), require('@/services/composables/thesaurus'), require('@/services/util/index')) : typeof define === 'function' && define.amd ? define(['vue', 'lodash', '@ckeditor/ckeditor5-vue/dist/ckeditor.js', '@ckeditor/ckeditor5-vue', '@scbd/ckeditor5-build-inline-full/build/ckeditor.js', '@scbd/ckeditor5-build-inline-full/build/ckeditor.css', '@/services/composables/i18n', '@/services/filters/lstring', 'axios', '@/services/composables/thesaurus', '@/services/util/index'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.ScbdCommonComponentsControlsKmKmInputRichLstring = factory(global.Vue, global._, null, global.CKEditor, global.ClassicEditor, null, null, null, global.axios, global.thesaurus, global.index));
})(this, function (Vue, _, ckeditor_js, CKEditor, ClassicEditor, ckeditor_css, i18n, lstring$1, axios, thesaurus, index) {
  'use strict';
  ...
  var script = {
    ...
    setup(__props, _ref3) {
      ...
      return (_ctx, _cache) => {
        return Vue.openBlock(), Vue.createElementBlock("div", _hoisted_1, [Vue.createElementVNode("div", {
        ...
        }, [Vue.createElementVNode("ul", _hoisted_3, [(Vue.openBlock(true), Vue.createElementBlock(Vue.Fragment, null, Vue.renderList(props.locales, locale => {
          ...
          }, Vue.toDisplayString(Vue.unref(lstring)(getTerm(locale).title || locale)), 11 /* TEXT, CLASS, PROPS */, _hoisted_5)], 8 /* PROPS */, _hoisted_4);
          ...
          }, [selectedLocale.value == locale ? (Vue.openBlock(), Vue.createBlock(script$1, {
            key: 0,
          ...
          }, null, 8 /* PROPS */, ["modelValue", "identifier", "locale", "config"])) : Vue.createCommentVNode("v-if", true)], 10 /* CLASS, PROPS */, _hoisted_6);
...
//# sourceMappingURL=km-input-rich-lstring.umd.js.map
