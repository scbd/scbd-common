    ...
    (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(__props.locales, (locale) => {
      return (vue.openBlock(), vue.createElementBlock("div", {
        ...
        vue.createElementVNode("div", _hoisted_4$1, [
          ...
          }, vue.toDisplayString(locale.toUpperCase()), 9 /* TEXT, PROPS */, _hoisted_5$1)
        ])
      ], 2 /* CLASS */))
    }), 128 /* KEYED_FRAGMENT */))
  ]))
...
const _hoisted_6 = /*#__PURE__*/vue.createElementVNode("i", { class: "bi bi-trash" }, null, -1 /* HOISTED */);
        ...
        vue.createElementVNode("div", _hoisted_2, [
          ...
          vue.createElementVNode("div", _hoisted_4, [
            vue.createElementVNode("button", {
              ...
              _hoisted_6,
              vue.createTextVNode(" " + vue.toDisplayString(t("remove")), 1 /* TEXT */)
            ], 8 /* PROPS */, _hoisted_5)
          ])
        ])
      ]))
...
//# sourceMappingURL=km-input-lstring-ml.cjs.map
