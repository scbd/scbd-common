...
const _hoisted_5$1 = /*#__PURE__*/Vue.createElementVNode("i", { class: "fa fa-edit" }, null, -1 /* HOISTED */);
        ...
        preProcessOEmbed() {
            ...
            setTimeout(function(){
                ...
                document.querySelectorAll( 'oembed[url]' ).forEach(async function(element) {
                    ...
                    const response = await axios__default["default"].get('/api/v2020/oembed', {params:params});                    
...
const _hoisted_8 = /*#__PURE__*/Vue.createElementVNode("i", { class: "fa fa-spinner fa-spin" }, null, -1 /* HOISTED */);
  ...
  return (Vue.openBlock(), Vue.createElementBlock("div", _hoisted_1, [
    (!$data.loading)
      ? (Vue.openBlock(), Vue.createElementBlock("div", _hoisted_2, [
          Vue.renderSlot(_ctx.$slots, "article-cover-image", {}, () => [
            (!$props.hideCoverImage && $props.article && $props.article.coverImage && $props.article.coverImage.url)
              ? (Vue.openBlock(), Vue.createElementBlock("div", _hoisted_3, [
                  Vue.createVNode(_component_cbd_article_cover_image, {
                    "cover-image": $props.article.coverImage
                  }, null, 8 /* PROPS */, ["cover-image"])
                ]))
              : Vue.createCommentVNode("v-if", true)
          ]),
          Vue.renderSlot(_ctx.$slots, "article-add-new", {}, () => [
            ($data.hasEditRights)
              ? (Vue.openBlock(), Vue.createElementBlock("div", _hoisted_4, [
                  Vue.createVNode(_component_cbd_add_new_article, {
                    tags: $props.tags,
          ...
          Vue.renderSlot(_ctx.$slots, "article", {}, () => [
            ($props.article)
              ? (Vue.openBlock(), Vue.createElementBlock("div", {
                  key: 0,
          ...
          Vue.renderSlot(_ctx.$slots, "article-empty", {}, () => [
            (!$props.article)
              ? (Vue.openBlock(), Vue.createElementBlock("div", _hoisted_6, "No information is available for this section at the moment."))
              : Vue.createCommentVNode("v-if", true)
          ])
        ]))
      : Vue.createCommentVNode("v-if", true),
    Vue.renderSlot(_ctx.$slots, "article-loading", {}, () => [
      ($data.loading)
        ? (Vue.openBlock(), Vue.createElementBlock("div", _hoisted_7, [
            Vue.createTextVNode("Loading content... "),
            _hoisted_8
          ]))
        : Vue.createCommentVNode("v-if", true)
    ])
...
//# sourceMappingURL=cbd-article.cjs.map
