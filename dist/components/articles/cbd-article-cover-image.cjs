  ...
  return (__props.coverImage.url)
    ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1, [
        ...
        (__props.coverImage.credits)
          ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_2, vue.toDisplayString(__props.coverImage.credits), 1 /* TEXT */))
          : vue.createCommentVNode("v-if", true),
...
//# sourceMappingURL=cbd-article-cover-image.cjs.map
