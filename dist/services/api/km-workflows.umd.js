(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('axios'), require('lodash'), require('vue')) : typeof define === 'function' && define.amd ? define(['axios', 'lodash', 'vue'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.ScbdCommonServicesApiKmWorkflows = factory(global.axios, global.lodash, global.Vue));
  ...
  class KmWorkflowsApi extends ApiBase {
    ...
    async getWorkflowHistory() {
      ...
      return this.http.get("/api/v2013/workflows", {
        params
      }).then(res => res.data).catch(tryCastToApiError);
    }
    async getWorkflow(workflowId) {
      if (!isValid(workflowId)) throw Error("invalid value for workflowId");
      return this.http.get("/api/v2013/workflows/".concat(encodeURIComponent(workflowId))).then(res => res.data).catch(tryCastToApiError);
    }
    async getBatchWorkflowDetails(batchId) {
      //:Promise<EKmDocumentsBatchWorkflow>  {
      if (!isValid(batchId)) throw Error("invalid value for batchId");
      return this.http.get("/api/v2013/workflows/batches/".concat(encodeURIComponent(batchId))).then(res => res.data).catch(tryCastToApiError);
    }
    async updateActivity(id, activityName, body) {
      ...
      return this.http.put("/api/v2013/workflows/".concat(id, "/activities/").concat(activityName), body).then(res => res.data).catch(tryCastToApiError);
    }
    async updateBatchActivity(id, activityName, body) {
      if (!isValid(id)) throw Error("invalid value for id");
      if (!isValid(activityName)) throw Error("invalid value for activityName");
      if (!isValid(body)) throw Error("invalid value for body");
      return this.http.put("/api/v2013/workflows/batches/".concat(id, "/activities/").concat(activityName), body).then(res => res.data).catch(tryCastToApiError);
    }
    async cancelWorkflow(id) {
      ...
      return this.http.delete("/api/v2013/workflows/".concat(id), {
        params
      }).then(res => res.data).catch(tryCastToApiError);
    }
    async cancelBatch(batchId) {
      ...
      return this.http.delete("/api/v2013/workflows/batches/".concat(batchId), {
        params
      }).then(res => res.data).catch(tryCastToApiError);
    }
  }
  return KmWorkflowsApi;
});
//# sourceMappingURL=km-workflows.umd.js.map
