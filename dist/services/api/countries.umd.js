(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('axios'), require('lodash'), require('vue')) : typeof define === 'function' && define.amd ? define(['axios', 'lodash', 'vue'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.ScbdCommonServicesApiCountries = factory(global.axios, global.lodash, global.Vue));
  ...
  class CountriesApi extends ApiBase {
    ...
    async getCountries() {
      ...
      return this.http.get("/api/v2013/countries", {
        params
      }).then(res => {
        return res.data;
    ...
    async getCountry(code) {
      ...
      return this.http.get("/api/v2013/countries/".concat(encodeURIComponent(code))).then(res => res.data).catch(tryCastToApiError);
    }
  }
  return CountriesApi;
});
