(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('axios'), require('lodash'), require('vue')) : typeof define === 'function' && define.amd ? define(['axios', 'lodash', 'vue'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.ScbdCommonServicesApiRealmConfiguration = factory(global.axios, global.lodash, global.Vue));
  ...
  class RealmConfigurationAPI extends ApiBase {
    constructor(options) {
      super(options);
    }
    async queryRealmConfigurations() {
      let {
        q,
        f,
        s,
      ...
      return this.http.get("/api/v2018/realm-configurations", {
        params
      }).then(res => res.data).catch(tryCastToApiError);
    }
    async getRealmConfigurationByHost() {
      let {
        host
      } = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      if (!host) {
      ...
      return this.http.get("/api/v2018/realm-configurations/".concat(encodeURIComponent(host) || '')).then(res => res.data).catch(tryCastToApiError);
    }
  }
  return RealmConfigurationAPI;
});
//# sourceMappingURL=realm-configuration.umd.js.map
